...
import (
	...
	_ "github.com/vulsio/go-cti/docs" // docs are generated by Swag CLI, you have to import it.
)
...
func Start(logToFile bool, logDir string, driver db.DB) error {
	...
	if logToFile {
		...
		if err != nil {
			return fmt.Errorf("Failed to open a log file: %s", err)
		}
		defer f.Close()
...
func info() echo.HandlerFunc {
	return func(context echo.Context) error {
		...
		message.Text = "GO Cyber Threat Intelligence"
...
func getCtiByCtiID(driver db.DB) echo.HandlerFunc {
	return func(context echo.Context) (err error) {
		...
		if err != nil {
			return fmt.Errorf("Failed to get CTI by CTI-ID. err: %w", err)
		}
...
func getCtiByMultiCtiID(driver db.DB) echo.HandlerFunc {
	return func(context echo.Context) (err error) {
		...
		if err != nil {
			return fmt.Errorf("Failed to get CTIs by CTI-IDs. err: %w", err)
		}
...
func getTechniqueIDsByCveID(driver db.DB) echo.HandlerFunc {
	return func(context echo.Context) (err error) {
		...
		if err != nil {
			return fmt.Errorf("Failed to get TechniqueIDs by CVE-ID. err: %w", err)
		}
...
func getTechniqueIDsByMultiCveID(driver db.DB) echo.HandlerFunc {
	return func(context echo.Context) (err error) {
		...
		if err != nil {
			return fmt.Errorf("Failed to get TechniqueIDs by CVE-IDs. err: %w", err)
		}
...
func getAttackerIDsByTechniqueIDs(driver db.DB) echo.HandlerFunc {
	return func(context echo.Context) (err error) {
		...
		if err != nil {
			return fmt.Errorf("Failed to get AttackerIDs by TechniqueIDs. err: %w", err)
		}
